...
dell'orchestratore, la qualità del responso degli agenti verticali (execution accuracy
per il Text-to-SQL, faithfulness per il RAG) e fornisce una stima indicativa 
