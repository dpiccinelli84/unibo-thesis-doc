...
--- riportare il numero restituito dall'ultima query, non quello
ricordato da un turno precedente --- ha eliminato in fase di test una
classe di errori di ricalcolo (Sez.~\ref{subsec:allycare-discipline}),
ed è una contromisura diretta al fenomeno
