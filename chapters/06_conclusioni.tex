...
l'implementazione e la valutazione di un sistema multi-agente orchestrato, realizzato internamente a Coop Alleanza 3.0. 

I contributi sono tre, in ordine di centralità.

\paragraph{1. Suite di agenti verticali specializzati.} Il Capitolo~\ref{chap:agenti} ha descritto la progettazione e l'implementazione di quattro agenti,
...
\paragraph{2. Orchestratore Orion.} Il Capitolo~\ref{chap:orion} ha presentato Orion,
...
A complemento della valutazione del routing, il Capitolo~\ref{chap:orion-valutazione} cataloga le tecniche di \emph{prompt engineering} applicate ai dati aziendali reali dei singoli agenti (Sez.~\ref{sec:eval-prompteng})
e riporta una valutazione quantitativa della qualità dei sub-agenti:
...
Analizza inoltre il trade-off costo--qualità realizzato dal routing per complessità (Sez.~\ref{sec:eval-costo-qualita}): ai listini correnti dei modelli, instradare l'$86{,}7\%$ del traffico verso il modello economico riduce il costo dell'inferenza di un fattore $\approx 2{,}9\times$ senza degradare la qualità sulla fascia complessa.
Una valutazione economica indicativa (Sez.~\ref{sec:eval-costi}) dà infine sostanza alla motivazione di costo: nello scenario illustrativo considerato,
